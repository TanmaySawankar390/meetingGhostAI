...
const GLSLHills = ({ width = '100vw', height = '100%', cameraZ = 125, planeSize = 256, speed = 0.5 }) => {
  ...
  return (
    <div ref={containerRef} className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none z-0" style={{ opacity: 0.6 }}> 
      <canvas
        ref={canvasRef}
        className="absolute inset-0 w-full h-full"
      />
      {/* Fallback gradient at the bottom to transition cleanly */}
      <div className="absolute inset-bottom h-32 bg-gradient-to-t from-white to-transparent bottom-0 w-full" />
    </div>
  );
};
